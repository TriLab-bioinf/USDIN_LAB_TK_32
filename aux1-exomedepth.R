...
exomeDepth <- function(my.test.num=NULL, outdir=NULL, sample=NULL, ExomeCount, my.ref.samples, exons.mm10.GRanges){
  ...
  file.copy(from = "./chromosome.svg", to = paste0("./",outdir,"/", "chromosome_",sample,".svg"))
  file.copy(from = "./chromosome.png", to = paste0("./",outdir,"/", "chromosome_",sample,".png"))
}
